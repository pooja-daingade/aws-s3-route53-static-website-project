...
* Configured public access for website hosting
* Configured Amazon Route 53 Hosted Zone
* Created an Alias (A) Record pointing to the S3 website endpoint
* Successfully mapped the custom root domain to the website
...
**Custom Domain:** `poojadaingade.shop`
...
* `AWS-S3-Static-Website-Hosting-with-Root-Domain-Configuration.pdf`
